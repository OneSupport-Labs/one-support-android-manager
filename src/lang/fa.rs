...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep OneSupport background service", "را در پس زمینه نگه دارید RustDesk سرویس"),
        ...
        ("Show OneSupoort", "RustDesk نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ...
        ("verify_one_support_password_tip", "رمز عبور RustDesk را تأیید کنید"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید RustDesk Server Pro لظفا"),
        ...
        ("About OneSupport", "RustDesk درباره"),
        ...
        ("upgrade_remote_one_support_client_to_{}_tip", "لطفاً RustDesk را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
