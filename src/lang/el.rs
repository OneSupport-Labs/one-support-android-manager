...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Γλώσσα"),
        ("Keep OneSupport background service", "Εκτέλεση του RustDesk στο παρασκήνιο"),
        ...
        ("Show OneSupoort", "Εμφάνιση RustDesk"),
        ...
        ("verify_one_support_password_tip", "Επιβεβαιώστε τον κωδικό του RustDesk"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον RustDesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("About OneSupport", "Πληροφορίες για το RustDesk"),
        ...
        ("upgrade_remote_one_support_client_to_{}_tip", "Αναβαθμίστε τον πελάτη RustDesk στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
