...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep OneSupport background service", "Rulează serviciul RustDesk în fundal"),
        ...
        ("Show OneSupoort", "Afișează RustDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("verify_one_support_password_tip", "Verifică parola RustDesk"),
