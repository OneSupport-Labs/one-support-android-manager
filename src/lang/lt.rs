...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep OneSupport background service", "Palikti RustDesk fonine paslauga"),
        ...
        ("Show OneSupoort", "Rodyti RustDesk"),
        ...
        ("verify_one_support_password_tip", "Įveskite kliento RustDesk slaptažodį"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", ""),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_one_support_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės RustDesk klientą į {} ar naujesnę versiją!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
