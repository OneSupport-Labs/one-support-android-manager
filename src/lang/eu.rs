...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep OneSupport background service", "Mantendu RustDesk atzeko planoko zerbitzu bezala"),
        ...
        ("Show OneSupoort", "Erakutsi RustDesk"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ...
        ("verify_one_support_password_tip", "Berretsi RustDesk pasahitza"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "Mesedez, bertsio-berritu RustDesk Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_one_support_client_to_{}_tip", "Mesedez, eguneratu RustDesk bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
