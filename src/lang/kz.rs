...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Тіл"),
        ("Keep OneSupport background service", "Артжақтағы RustDesk сербесін сақтап тұру"),
        ...
        ("View Mode", ""),
        ("login_linux_tip", ""),
        ("verify_one_support_password_tip", ""),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_one_support_client_to_{}_tip", "Қашықтағы жақтағы RustDesk клиентін {} немесе одан жоғары нұсқаға жаңартуды өтінеміз!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
