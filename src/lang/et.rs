...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Keel"),
        ("Keep OneSupport background service", "Säilita RustDeski taustateenus"),
        ...
        ("verify_one_support_password_tip", "Kinnita RustDeski parool"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "Palun täienda RustDesk Server Pro versioonile {} või uuem!"),
        ...
        ("About OneSupport", "RustDeski teave"),
        ...
        ("upgrade_remote_one_support_client_to_{}_tip", "Täiendage RustDeski klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
