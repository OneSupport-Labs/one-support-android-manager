...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Jezik"),
        ("Keep OneSupport background service", "Ohrani RustDeskovo storitev v ozadju"),
        ...
        ("Show OneSupoort", "Prikaži RustDesk"),
        ...
        ("verify_one_support_password_tip", "Preveri geslo za RustDesk"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "Prosimo, nadgradite RustDesk Server Pro na različico {} ali novejšo."),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_one_support_client_to_{}_tip", "Prosimo, nadgradite RustDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
