...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "ენა"),
        ("Keep OneSupport background service", "RustDesk-ის ფონური სერვისის შენარჩუნება"),
        ...
        ("Show OneSupoort", "RustDesk-ის ჩვენება"),
        ...
        ("verify_one_support_password_tip", "დაადასტურეთ RustDesk-ის პაროლი"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "განაახლეთ RustDesk Server Pro ვერსიამდე {} ან უფრო ახალი!"),
        ...
        ("About OneSupport", "RustDesk-ის შესახებ"),
        ...
        ("upgrade_remote_one_support_client_to_{}_tip", "განაახლეთ RustDesk კლიენტი ვერსიამდე {} ან უფრო ახალი დისტანციურ მხარეზე!"),
