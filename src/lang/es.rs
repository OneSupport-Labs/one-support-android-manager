...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep OneSupport background service", "Dejar RustDesk como Servicio en 2do plano"),
        ...
        ("Show OneSupoort", "Mostrar RustDesk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("verify_one_support_password_tip", "Verificar la contraseña de RustDesk"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "¡Por favor, actualiza RustDesk Server Pro a la versión {} o superior"),
        ...
        ("About OneSupport", "Acerca de RustDesk"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_one_support_client_to_{}_tip", "Por favor, actualiza el cliente RustDesk a la versión {} o superior en el lado remoto"),
