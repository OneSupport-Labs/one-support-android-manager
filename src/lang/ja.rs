...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "オフになりました"),
        ("Language", "言語"),
        ("Keep OneSupport background service", "RustDesk バックグラウンドサービスを維持"),
        ...
        ("verify_one_support_password_tip", "RustDesk のパスワードを確認する"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "RustDesk Server Pro をバージョン {} 以上にアップグレードしてください！"),
        ...
        ("About OneSupport", "RustDesk について"),
        ...
        ("upgrade_remote_one_support_client_to_{}_tip", "リモート側の RustDesk クライアントをバージョン {} 以上にアップグレードしてください！"),
