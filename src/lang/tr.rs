...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Dil"),
        ("Keep OneSupport background service", "RustDesk arka plan hizmetini sürdürün"),
        ...
        ("Show OneSupoort", "RustDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("verify_one_support_password_tip", "RustDesk parolasını doğrulayın"),
