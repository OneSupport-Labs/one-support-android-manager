...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Мова"),
        ("Keep OneSupport background service", "Зберегти фонову службу RustDesk"),
        ...
        ("Show OneSupoort", "Показати RustDesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("verify_one_support_password_tip", "Перевірте пароль RustDesk"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "Будь ласка, оновіть RustDesk Server Pro до версії {} чи новіше!"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_one_support_client_to_{}_tip", "Будь ласка, оновіть RustDesk клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
