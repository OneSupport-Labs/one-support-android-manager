...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep OneSupport background service", "השאר את שירות הרקע של RustDesk פעיל"),
        ...
        ("Show OneSupoort", "הצג את RustDesk"),
        ("This PC", "מחשב זה"),
        ("or", "או"),
        ...
        ("verify_one_support_password_tip", "אמת סיסמת RustDesk"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "אנא שדרג את RustDesk Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("About OneSupport", "אודות RustDesk"),
        ...
        ("upgrade_remote_one_support_client_to_{}_tip", "אנא שדרג את לקוח RustDesk לגרסה {} או חדשה יותר בצד המרוחק!"),
