...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Idioma"),
        ("Keep OneSupport background service", "Manté el servei del RustDesk en rerefons"),
        ...
        ("Show OneSupoort", "Mostra el RustDesk"),
        ...
        ("verify_one_support_password_tip", "Verifica la contrasenya del RustDesk"),
        ...
        ("upgrade_one_support_server_pro_to_{}_tip", "Actualitzeu el RustDesk Server Pro a la versió {} o superior!"),
        ...
        ("About OneSupport", "Quant al RustDesk"),
        ...
        ("upgrade_remote_one_support_client_to_{}_tip", ""),
        ("d3d_render_tip", ""),
